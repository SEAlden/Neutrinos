#ifndef Disappearance_h
#define Disappearance_h
...
public:
  Disappearance(int kNuBarVar, std::string path, std::string filename, std::string filename2, std::string filename3, std::string filename4, int mass, double scale);
    ~Disappearance();
