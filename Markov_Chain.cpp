...
//    width.push_back(1/width_factor); // beta : 8
    width.push_back(1.00043/width_factor);
    width.push_back(-0.00513335/width_factor);
    width.push_back(-0.81076/width_factor);
    width.push_back(-0.0217913/width_factor);
    width.push_back(0.223944/width_factor);
    width.push_back(0.0340821/width_factor);
    width.push_back(-0.0569585/width_factor);
    width.push_back(0.0133551/width_factor);
    width.push_back(-0.000970247/width_factor);
...
void Markov_Chain::startMH(std::vector<double> coef, Disappearance* oscObject, bool dis){
    currentLLH = oscObject->getLLH();
    //int count =0;
