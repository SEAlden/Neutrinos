    ...
    for(int i=0; i<steps; i++){
        if(i%1000==0 || i==0){
            ...
            if(i==0){
                ...
                std::cout << "i " << i << " "  << "Running random walk..." << i << std::endl;
            }
        ...
        for(int k = 0; k<currentPars.size();k++){
            if(pars_bool[k]){
                ...
                oscObject->set_param(k, proposedPars[k],'p');
       ...
       std::cout << i << "\t" << currentLLH << "\t" << proposedLLH << "\t" << currentLLH-proposedLLH << " prop " << proposedPars[1] << std::endl;
...
//
//             else{
//                 std::cout << "Running random walk..." << i << std::endl;
//             }
//
//         }
//
