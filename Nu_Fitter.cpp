...
void Nu_Fitter::make_sum(char hist_type, char phenom_mode, bool oscillate){
...
void Nu_Fitter::show_hist(char hist_type){
    ...
    if(hist_type == 'd'){
        ...
        _Prediction->Draw("HIST SAME"); // to plot histogram without original error bar
    }
...
std::vector<double> Nu_Fitter::return_pparam(){
...
//void Nu_Fitter::make_2d(std::string root_file){
//    
//    TFile* file = new TFile(root_file.c_str());
//    TTree* tree = (TTree*)file->Get("t");
//    std::vector<double> pars(9);
//    
...
//
//    
//    TH2D* hFunction = new TH2D("hf","",200,0,2,200,-0.5,2.5);
//    
...
//    }
//    
//    TFile* outfile2d = new TFile("outfile2d.root","RECREATE");
//    hFunction->Write();
//    outfile2d->Close();
//    //hFunction->Draw("colz");
//
